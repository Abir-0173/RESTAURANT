          ...
          <div className='col-12 col-md-7'>
            <Form onSubmit={this.handleSubmit}>
              ...
              <FormGroup row>
                ...
                <Col md={10}>
                  <Input type='tel' name='telnum' placeholder='Teliphone Number' value={this.state.telnum} onChange={this.handleInputChange} />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label htmlFor='email' md={2}>E-mail</Label>
                <Col md={10}>
                  <Input type='email' name='email' placeholder='E-mail Address' value={this.state.email} onChange={this.handleInputChange} />
                </Col>
              </FormGroup>
              <FormGroup row>
              ...
              <FormGroup>
                ...
                <Col md={10}>
                  <Input type='textarea' name='message' placeholder='Type your message here...' value={this.state.message} onChange={this.handleInputChange} rows="12" />
                </Col>
              </FormGroup>
              <FormGroup>
                <Col>
